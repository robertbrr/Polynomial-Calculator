...
public class LiveInputVerifier {
    ...
    private boolean exponentStarted = false;
    private boolean numberStartingWithZero = false;
    ...
    public void inputCheckerAndAdder(char toBeAdded){
        if(textField.getText().length() == 0){
            ...
            if (lastChar == 'X') {
                ...
                //else JOptionPane.showMessageDialog(null,"Please insert a number as exponent!");
